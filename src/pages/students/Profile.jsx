...
export default function StudentProfile() {
  ...
  // Sample enrolled courses - you might want to get this from Redux too
  ...
  // Sample certificates - you might want to get this from Redux too
  const certificates = [
    {
      id: 1,
  ...
  const handlePasswordUpdate = () => {
    ...
    // In real app, this would make API call and dispatch action
    ...
    <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 overflow-hidden">
        ...
        <div className="relative flex justify-between items-center">
          ...
          {!isEditing ? (
            ...
            <div className="flex space-x-3">
              ...
              >
                <Save size={16} className={isProcessing ? 'animate-spin' : ''} />
              ...
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-4 border border-blue-100">
                <div className="text-center">
                  <div className="text-2xl font-bold text-gray-800">
                    {currentUser?.user?.studentId ? currentUser.user.studentId : 'N/A'}
                  </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  {isEditing ? (
                    ...
                    <div className="flex items-center space-x-3 p-4 bg-white rounded-xl border-2 border-gray-100 shadow-sm">
                      ...
                      <span className="text-gray-800 font-medium">{studentData.name || 'Not provided'}</span>
                    </div>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center space-x-3 p-4 bg-gray-50 rounded-xl border-2 border-gray-100">
                    ...
                    <span className="text-gray-700">{studentData.email || 'Not provided'}</span>
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  {isEditing ? (
                    ...
                    <div className="flex items-center space-x-3 p-4 bg-white rounded-xl border-2 border-gray-100 shadow-sm">
                      ...
                      <span className="text-gray-800 font-medium">{studentData.phone || 'Not provided'}</span>
                    </div>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  {isEditing ? (
                    ...
                    <div className="flex items-center space-x-3 p-4 bg-white rounded-xl border-2 border-gray-100 shadow-sm">
                      ...
                      <span className="text-gray-800 font-medium">{studentData.dateOfBirth || 'Not provided'}</span>
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="mt-6 space-y-2">
                ...
                {isEditing ? (
                  ...
                  <div className="p-4 bg-white rounded-xl border-2 border-gray-100 shadow-sm">
                    <span className="capitalize text-gray-800 font-medium">{studentData.gender || 'Not specified'}</span>
                  </div>
                )}
              </div>
            </div>
      ...
      {activeTab === 'courses' && (
        <div className="bg-white rounded-lg shadow-sm p-6">
          <h2 className="text-xl font-semibold text-gray-800 mb-6">Enrolled Courses</h2>
              ...
              <div key={course.id} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                <div className="flex justify-between items-start mb-3">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Enrolled: {new Date(course.enrolled).toLocaleDateString()}</p>
                  </div>
                ...
                <div key={cert.id} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Course: {cert.courseTitle}</p>
